          ...
          <v-list >
            ...
            >
              <v-list-item>
                ...
                <v-btn color="primary" class="mr-12" v-if="isForeman || isAdmin" @click="showChecklistNotDialog(checklist)">
                  Notiz hinzufügen
                </v-btn>
                <v-btn class="mr-12" v-if="checklist.notes || checklist.images.length" :to="`/standard-checklist/show/` + checklist.id"  icon color="primary">
                ...
                <v-btn class="ml-12 mr-8" icon color="primary" @click="changeChecklistItemStatus(checklist.id,0)">
                  <v-icon color="green darken-2" v-if="checklist.status || checklist.status == null">mdi-checkbox-blank-outline</v-icon>
